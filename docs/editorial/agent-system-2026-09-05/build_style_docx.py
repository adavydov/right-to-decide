...
r=footer.add_run('Право на решение · Правило стиля STYLE-01 · ')
...
while i<len(lines):
    ...
    i+=1
doc.core_properties.title='Право на решение: правило стиля STYLE-01'
doc.core_properties.subject='Лёгкая футурологическая проза с научной глубиной'
doc.core_properties.author='Редакционная записка для авторов монографии'
target=base/'editorial-style.docx'
doc.save(target)
