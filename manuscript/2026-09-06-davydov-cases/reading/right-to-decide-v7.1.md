...
Литературная редакция 7.1 · 6 сентября 2026 года
...
Разница между решением внутри порядка и изменением порядка видна в кейсе Егора Давыдова «Два адмирала и один флот». Автор описывает двух промышленных партнёров, одновременно участвовавших во множестве строительных проектов. Независимого подтверждения обстоятельств у нас нет; разберём устройство конфликта по представленному описанию.[16]

Одна сторона придавала большее значение инженерной надёжности, другая — стоимости и достаточности решения для будущей эксплуатации. Обе располагали профессиональными основаниями. На стыках работ возникали вопросы, по которым требовалось совместное решение. Дополнительные расчёты позволяли каждой стороне убедительнее защищать свой выбор, но не приближали согласие о том, сколько надёжности покупать и за чей счёт.

Сначала искали более удобный способ согласовывать решения. Поворот произошёл, когда поставили под вопрос саму необходимость согласовывать их в таком количестве. Перестройка дала партнёрам больше самостоятельной ответственности и уменьшила число решений, для которых требовалось взаимное одобрение. Они получили возможность продолжить работу, сохраняя различия в подходах.
...
Для нашего вопроса существенно, что новая возможность появилась без предварительного согласия о каждом техническом выборе. Участникам стало нужно меньше взаимных разрешений. Это уточняет смысл соавторства: постоянное совместное обсуждение способно отнимать именно ту самостоятельность, ради которой его вводят.

Но из этого не следует, что одному участнику надо передать всю власть. Самостоятельное решение в определённой области совместимо с соавторством, когда границы области согласованы, ответственность понятна, а распределение полномочий доступно пересмотру. Это наш вывод из разбора, а не установленное описание всех прав сторон в том партнёрстве.
...
Кейс показывает изменение организации деятельности; роста способности участников учиться он не устанавливает. Образовательный вопрос начинается дальше: как человек замечает, что дополнительного знания о задаче уже мало и пора исследовать устройство самой работы? Для этого нужно уметь не только обосновать свой вариант, но и увидеть, почему другим приходится его согласовывать, какие решения можно разделить и где общая ответственность сохраняется.

Вернёмся к приёмному узлу. Отдельные производственные звенья могут самостоятельно выбирать способы работы при общих требованиях к совместимости, безопасности и ответственности. Согласование каждого изменения всеми не обязательно. Но автономия нынешних участников ещё не открывает путь следующим. Действующим поставщикам незачем отдавать часть времени тем, кого пока нет внутри. Их единогласие может быть добросовестным: они вложились в узел и поддерживают оборудование. Работающий коллектив способен управлять собой и препятствовать появлению другого коллектива.

Исследования Элинор Остром помогают не сводить управление общими ресурсами к одной форме собственности. В переработанном черновике Нобелевской лекции она отмечает разнообразие конкретных правил; среди более общих характеристик устойчивых устройств рассматривает участие затронутых пользователей в изменении норм, подотчётное наблюдение и доступное разрешение конфликтов.[17] В нашем вопросе требуется ещё один шаг: кто представляет интерес людей, которые не стали пользователями именно из-за действующего порядка?
...
Каждый способен и изменить сторону. Покупатель, заключивший выгодный долгий договор, может утратить интерес к конкуренции. Первые внешние команды, получив места, — поддержать закрытие следующих. Поэтому право пересмотра должно пережить перемену интересов тех, кто однажды его создал.
...
Образование помогает собрать проверяемое предложение, оценить цену и найти союзников. Если же учить только успешному заполнению заявок, школа будет воспроизводить хороших пользователей того же закрытого правила.
...
Право на решение теперь включает влияние на то, какие решения участник обязан согласовывать и как можно изменить сам этот круг. Для новичка это возможность пересмотреть устройство, в котором места ему ещё не было. Но она не делает его готовым лично выполнить любую техническую операцию. Передача такого действия требует другого основания доверия.
...
У Пейперта и Харел есть точное ограничение педагогического притязания: пригодность способа обучения для некоторых ещё не означает, что он лучше для всех. Авторы связывают это различие с интеллектуальными предпочтениями.[18] Даже удачная инженерная школа не получает права определить единственную достойную форму становления. Работа над полезным предметом, фундаментальный разбор и долгое исследование без готового продукта могут требовать разных сред.
...
[16] Егор Давыдов. *Два адмирала и один флот*. Предоставленный пользователем PDF, 9 страниц; дата авторской редакции не установлена. Библиотека проекта: источник 49. PDF-с. 2–6: совместное участие в строительстве, различие критериев, затруднение согласования, перестройка и ограниченный исход. Авторство указано пользователем 6 сентября 2026 года; тогда же прочитан файл. Обстоятельства независимо не подтверждены. Условная пятикратная разница стоимости, реконструированные мысли и речь в главу не перенесены. Предположения исходника об ответе ИИ не считаются проведённым опытом. Сведения о росте способности учиться и полном распределении последствий между затронутыми сторонами отсутствуют.

[17] Elinor Ostrom, [*Beyond Markets and States: Polycentric Governance of Complex Economic Systems*](https://dlc.dlib.indiana.edu/dlc/bitstreams/0a7a52e6-8cf0-42c3-ae20-776095e6fd1d/download), revised draft Нобелевской лекции 8 декабря 2009 года, §4E, печатные с.12–13, начало §5, с.14. Ограниченный пересказ прочитанного черновика; финальная статья *American Economic Review* 2010 года не выдаётся за тот же проверенный файл. Исследование общих ресурсов не подтверждает работоспособности предлагаемого космического режима.

Приоритет прежних поставок, самостоятельность звеньев в согласованных пределах и способы изменения доступа — проектные условия мысленного эксперимента. Новая коалиция, оплаченные испытания и открытый вход не объявлены состоявшимися. Сохранение профессиональной безопасности и прежних договоров входит в сравнение вариантов.
...
[20] NASA Small Spacecraft Systems Virtual Institute, [*7.0 Thermal Control*](https://www.nasa.gov/smallsat-institute/sst-soa/thermal-control/), §7.1, начало §7.2.1 и §7.3.4 *Fluid Loops*. Перенос тепла внутри аппарата и внешнее излучение различаются. NASA [*Reference Guide to the ISS*](https://www.nasa.gov/wp-content/uploads/2022/06/508318main_iss_ref_guide_nov2010.pdf), 2010, печатная с.92, описывает внутренний водяной и внешний аммиачный контуры. Это не подтверждает выбора воды для предполагаемого необитаемого модуля; его режим и экономика остаются непроверенными.

[21] NASA/JPL, [*Calculating Solar Power in Space*](https://www.jpl.nasa.gov/edu/resources/lesson-plan/calculating-solar-power-in-space/), *Background*: зависимость освещённости от расстояния и ограничения преобразования. Источник не подтверждает экономику предполагаемой индустрии.

[22] National Research Council, [*3D Printing in Space*](https://www.nationalacademies.org/read/18871/chapter/5), 2014, гл.3: *Quality, Verification, Validation, and Functional Testing*, *Infrastructure*, *Use of a Platform*, *Human Presence*, печатные с. 49–50, 52–54. Описанные в 2014 году условия не выдаются за современный обзор или доказательство вечной необходимости человека.
