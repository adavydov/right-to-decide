...
export function LegacyManifesto({archived=false}: {archived?:boolean}) {
  ...
  return (
    <main id="main-content" className={`subpage wrap ${styles.page}`}>
      <header className={styles.intro}>
        <p className="eyebrow">{archived?"Архив редакции 9.0 · Конституция 1.2.1":"Право на решение · Версия 1.2.1"}</p>
